...
public class MainWindow extends JFrame {
	...
	public MainWindow() {
		...
		gl_personalInfoTab
				.setHorizontalGroup(gl_personalInfoTab
		...
		lblNewLabel_2
				.setToolTipText("Die Kalender ID findest du unter Kalender-Einstellungen bei \"Kalenderadresse\"");
		lblNewLabel_2
		...
		trainingsChooser.setModel(new DefaultComboBoxModel<>(Qualification
				.values()));
	...
	public void updateRegisteredShifts() {
		...
		for (int i = 0; i < data.length; i++) {
			...
			float salary = 8.8f * shiftContainer.shiftInstances.get(i)
					.getTimeAsFloat();
	...
	protected void updateShiftsFromDPL() {
		...
		for (int i = 0; i < shifts.length; i++) {
			...
			String startingTime = UtilityBox.createTimeStringFromInt(shifts[i]
					.getStartingTime());
			String endTime = UtilityBox.createTimeStringFromInt(shifts[i]
					.getEndTime());
